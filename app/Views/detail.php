...
<div id="home">
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-md-6">
                <img src="<?= base_url('uploads/' . esc($kendaraan['gambar_kendaraan'], 'url')) ?>" alt="Detail Mobil" class="img-fluid mb-3 rounded">
            </div>
            <div class="col-md-6">
                <h3 class="mb-3"><?= esc(ucwords($kendaraan['merk_kendaraan'] . ' ' . $kendaraan['nama_kendaraan'])) ?></h3>
                <ul class="list-unstyled">
                    <li><strong>Tahun:</strong> <?= esc($kendaraan['tahun_kendaraan']) ?></li>
                    <li><strong>Harga Sewa:</strong> Rp. <?= number_format(esc($kendaraan['harga_sewa_kendaraan']), 2) ?> /hari</li>
                </ul>
                <p class="text-muted">Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non.</p>
                ...
                <form action="" method="POST" class="no-validated row g-3">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" name="no_telp_pelanggan" autocomplete="off" maxlength="13">
                        <?php if (isset($validation)): ?>
