...
<div class="container mt-4">
    ...
    <section class="section featured-car" id="featured-car">
        <div class="container">
            ...
            <h2 class="text-center mb-1 text-dark font-weight-bold">Garasi Kendaraan</h2>
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-title-wrapper">
                                <h3 class="h3 card-title">
                                    <a href="<?= base_url('detail/' . esc($kendaraan['id_kendaraan'])) ?>"><?= esc(ucwords($kendaraan['merk_kendaraan'])) ?>
                                        <?= esc(ucwords($kendaraan['nama_kendaraan'])) ?></a>
                                </h3>
                            ...
                            <div class="card-price-wrapper">
                                ...
                                <a href="<?= base_url('detail/' . esc($kendaraan['id_kendaraan'])) ?>" class="btn">
                                    Rent now
                                </a>
                            </div>
                        </div>
