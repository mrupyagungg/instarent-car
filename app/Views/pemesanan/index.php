...
<?php endif; ?>
    ...
    <div class="container">
        <!-- Header Title -->
        <h2 class="mb-4">Detail><?= isset($item['nama_kendaraan']) ? $item['nama_kendaraan'] : 'Data tidak tersedia'; ?></h2>

        <div class="row">
            <!-- Column 1: data kendaraan -->
            <div class="col">
                <img src=" <?php if (!empty($item['gambar_kendaraan'])): ?>
            <img src="<?= base_url('uploads/kendaraan/' . $item['gambar_kendaraan']); ?>" width="100" alt="Gambar Kendaraan">
        <?php else: ?>
            Tidak ada gambar
        <?php endif; ?>" alt="Detail Mobil"
                    class="img-fluid"><br>
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= isset($item['warna_kendaraan']) ? $item['warna_kendaraan'] : 'Data tidak tersedia'; ?></td>
                        </tr>
                        <tr>
