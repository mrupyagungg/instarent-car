...
<div class="container mt-4">
    ...
    <div class="row">
        <!-- Detail Kendaraan -->
        <div class="col-md-6">
            <img src="<?= base_url('uploads/' . esc($kendaraan['gambar_kendaraan'], 'url')) ?>" alt="Detail Kendaraan"
                class="img-fluid">
        ...
        <div class="col-md-6 card">
            ...
            <form action="/customer/store" method="post" id="pelangganForm">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" id="jenis_kelamin_pelanggan" name="jenis_kelamin_pelanggan" required>
                        <option value="">-- Pilih --</option>
                        <option value="Laki-laki"
                            <?= old('jenis_kelamin_pelanggan') === 'Laki-laki' ? 'selected' : '' ?>>Laki-laki</option>
                        <option value="Perempuan"
                            <?= old('jenis_kelamin_pelanggan') === 'Perempuan' ? 'selected' : '' ?>>Perempuan</option>
                    </select>
                </div>
