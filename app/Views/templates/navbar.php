 <nav class="navbar custom-navbar navbar-expand-lg py-2">
     <div class="container-fluid px-0">
         ...
         <a href="<?= base_url('/dashboard') ?>" class="navbar-brand"><img src="<?= base_url('assets/images/brand/icon.svg') ?>" alt="BigBucket" /> <strong>INSTA</strong> RENT</a>
         <div id="navbar_main">
             <ul class="navbar-nav ml-auto">
                 <li class="nav-item dropdown">
                     ...
                     <div class="dropdown-menu dropdown-menu-right">
                         ...
                         <a class="dropdown-item" href="<?= base_url('logout') ?>"><i class="fa fa-sign-out text-primary"></i>Sign out</a>
